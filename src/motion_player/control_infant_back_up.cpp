...
boost::mutex emgb_mutex_;
std_msgs::Bool emgb_; 
void emgbCallback(const std_msgs::BoolConstPtr& msg)
{
	boost::mutex::scoped_lock(emgb_mutex_);
	emgb_=*msg;	
}
